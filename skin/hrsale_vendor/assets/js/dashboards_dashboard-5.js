$(function () {
	...
	var hrsale_projects = new Chart(
		document.getElementById("hrsale_projects").getContext("2d"),
		{
			type: "bar",
			data: {
				datasets: [
					{
						data: [
							24, 92, 77, 90, 91, 78, 28, 49, 23, 81, 15, 97, 94, 16, 99, 61,
	...
	var hrsale_tasks = new Chart(
		document.getElementById("hrsale_tasks").getContext("2d"),
		{
			type: "line",
			data: {
				datasets: [
	...
	var hrsale_department = new Chart(
		document.getElementById("hrsale_department").getContext("2d"),
		{
			type: "pie",
			data: {
	...
	var hrsale_designation = new Chart(
		document.getElementById("hrsale_designation").getContext("2d"),
		{
			type: "pie",
			data: {
	...
	function resizeCharts() {
		grafik_mingguan.resize();
		grafik_bulanan.resize();
