...
<title>Ruang Belajar Aqil</title>
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-primary">
        <div class="panel-heading"> <strong class="">Ruang Belajar Aqil</strong> </div>
        ...
        <div class="panel-footer"><?php echo date('Y');?> Ruang Belajar Aqil</div>
      </div>
    </div>
  </div>
</div> 
