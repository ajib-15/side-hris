...
<ul class="sidenav-inner py-1">
  ...
  <?php } ?>
  <li class="sidenav-item <?= $this->router->fetch_class() === 'kegiatan' ? 'active' : '' ?>">
    <a href="<?php echo site_url('admin/kegiatan'); ?>" class="sidenav-link">
      <i class="sidenav-icon ion ion-md-book"></i>
      <div>Kegiatan</div>
    </a>
  </li>
