      ...
      <div class="card">
        <div class="p-4 p-sm-5">
          ...
          <?php $attributes = array(
            'class' => 'form-hrsale', 'name' => 'hrm-form', 'id' => 'hrm-form', 'data-redirect' => 'dashboard',
          ...
          <div class="d-flex justify-content-between align-items-center m-0">
            ...
            <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => 'btn btn-primary save mr-2', 'content' => '<i class="saveinfo fas fa-user-lock d-blockd"></i> ' . $this->lang->line('xin_login'))); ?> <img id="hrload-img" src="<?php echo base_url() ?>skin/img/loading.gif" style="">
          </div>
          <?php echo form_close(); ?>
          <!-- / Form -->
